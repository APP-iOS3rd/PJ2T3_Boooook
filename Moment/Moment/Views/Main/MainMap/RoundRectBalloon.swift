...
struct RoundRectBalloon: Shape {
	func path(in rect: CGRect) -> Path {
		...
		path.addRelativeArc(center: CGPoint(x: rect.maxX - 10, y: rect.minY + radius), radius: radius,
							startAngle: Angle.degrees(-90), delta: Angle.degrees(90))
		
		path.move(to: CGPoint(x: rect.maxX, y: rect.minY + radius))
		
		path.addLine(to: CGPoint(x: rect.maxX, y: rect.maxY - radius))
		path.addRelativeArc(center: CGPoint(x: rect.maxX - radius, y: rect.maxY - radius), radius: radius,
		...
		path.addLine(to: CGPoint(x: rect.midX - radius, y: rect.maxY))
		path.addRelativeArc(center: CGPoint(x: rect.minX + radius, y: rect.maxY - radius), radius: radius,
							startAngle: Angle.degrees(90), delta: Angle.degrees(90))
		
		path.addLine(to: CGPoint(x: rect.minX, y: rect.minY + 10))
		path.addRelativeArc(center: CGPoint(x: rect.minX + radius, y: rect.minY + 10), radius: radius,
